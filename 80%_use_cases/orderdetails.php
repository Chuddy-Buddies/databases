...
if($conn->connect_error)
{
    ...
    $conn->close();
        ...
        ?>
            ...
            <?php echo "Seller ID     :     " ?>
            <a href="viewseller.php?s_id=<?php echo $row["Seller_Username"]; ?>"><?php echo $row["Seller_Username"]; ?></a> <?php echo "&nbsp&nbsp&nbsp";?> <a href="Rate_Seller.html"><?php echo "Rate Seller"; ?></a>
            <?php echo "<br>";?>
